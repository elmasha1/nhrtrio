    ...
    <div className="space-y-5">
          ...
          <div key={c.id} className="card overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="mt-3 flex gap-2">
                ...
                <button onClick={() => del(c)} className="btn-ghost !py-2 !px-3 text-xs text-rose-600"><Trash2 className="h-3 w-3" /></button>
              </div>
            </div>
          </div>
        ))}
      ...
      {editing && (
        <form onSubmit={save} className="card p-5 sm:p-6">
          <h2 className="font-display text-xl font-semibold">{editing.id ? 'Edit' : 'New'} category</h2>
