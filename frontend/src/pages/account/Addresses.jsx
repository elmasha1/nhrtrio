    ...
    <div className="space-y-4">
        ...
        {list.map((a) => (
          <div key={a.id} className="card p-5">
            ...
            <div className="mt-3 flex gap-2">
              <button onClick={() => setEditing(a)} className="btn-outline !py-2 !px-3 text-xs">Edit</button>
              <button onClick={() => remove(a.id)} className="btn-ghost !py-2 !px-3 text-xs text-rose-600">
      ...
      {editing && (
        <form onSubmit={save} className="card p-5 sm:p-6">
          <h3 className="font-display text-xl font-semibold">{editing.id ? 'Edit address' : 'New address'}</h3>
